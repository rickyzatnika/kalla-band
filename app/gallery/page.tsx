...
//   }, { dependencies: [filtered] });
  ...
  return (
    <>
      <Navigation />
      <main className="flex min-h-screen flex-col items-center justify-center bg-[#090909] px-6">
        <p className="text-xs font-medium tracking-[0.3em] text-[#DC2626] capitalize">
          Visual
        </p>
        <h1 className="mt-4 text-center font-title text-6xl font-bold tracking-wide sm:text-7xl">
          Galeri
        </h1>
        <p className="mt-6 max-w-md text-center text-lg text-[#A1A1AA]">
          Halaman ini sedang dalam persiapan.
        </p>
        <TransitionLink
          href="/"
          className="mt-10 rounded-full border border-[rgba(255,255,255,0.15)] px-8 py-3.5 text-sm font-medium text-white transition-all duration-300 hover:border-white/30"
        >
          Kembali ke Beranda
        </TransitionLink>
      </main>
