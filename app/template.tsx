...
export default function Template({ children }: { children: ReactNode }) {
  ...
  return (
    <div>
      ...
      >
        <div className="backdrop-blur-md absolute inset-0 bg-gradient-to-t from-[#090909]  to-[#090909] " />
      </div>
      <div
        id="curtain-right"
        className="fixed top-0 right-0 z-[100] w-1/2 h-dvh overflow-hidden pointer-events-none"
      >
        <div className="backdrop-blur-md absolute inset-0 bg-gradient-to-t from-[#090909] via-[#090909]/80 to-[#090909]/60 " />
      </div>
      {children}
    </div>
  );
