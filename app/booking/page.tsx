          ...
          <div className="mx-auto max-w-3xl">
            ...
            >
              ...
              <button
                ...
                className="cursor-pointer inline-flex items-center gap-2 rounded-full bg-[#DC2626] px-8 py-3.5 text-sm font-medium text-white transition-all duration-300 hover:bg-[#EF4444] disabled:opacity-50"
              >
                {isSubmitting ? (
                  "Mengirim..."
                ) : (
            ...
            <div ref={infoRef} className="mt-16 grid gap-6 sm:grid-cols-2">
              ...
              >
                ...
                <p className="text-sm text-[#A1A1AA]">Email Official :</p>
